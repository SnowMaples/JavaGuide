...
**本项目为 [JavaGuide 知识星球](../about-the-author/zhishixingqiu-two-years.md) 内部专属实战项目，通过语雀文档在线阅读学习，不单独对外开放。**
...
并且，我的星球还有很多其他服务，比如**一对一提问、简历修改、后端系统面试资料（包含高频系统设计&场景题）、学习打卡**等，其中任何一项服务单独拎出来的价值都已远超星球门票。欢迎详细了解我的[知识星球](../about-the-author/zhishixingqiu-two-years.md)！
...
2. 为什么引入 Redis？
   ...
   - 基于 Redis Stream 实现简历分析、知识库向量化等场景的异步（还能解耦，分析和向量化可以使用其他编程语言来做）。不使用 [Kafka](../high-performance/message-queue/kafka-questions-01.md) 这类成熟的消息队列，也是不想引入太多组件。
3. 构建工具为什么选择 Gradle？个人更喜欢用 Gradle，也写过相关的文章：[Gradle核心概念总结](../tools/gradle/gradle-core-concepts.md)。
...
个人也更喜欢用 Gradle，也写过相关的文章：[Gradle 核心概念总结](../tools/gradle/gradle-core-concepts.md)。
